...
public class Util {	
	...
	public static String base64Encoder(String word) {
        final byte[] authBytes = word.getBytes(StandardCharsets.UTF_8);
	 ...
	 * 
	 * @param encodedString String encoded in base64 format.
	 * @return text in String utf8 format.
	 */
	public static String base64Decoder(String encodedString) {
        final byte[] authBytes = encodedString.getBytes(StandardCharsets.UTF_8);
        return new String(Base64.getDecoder().decode(authBytes));        
	}	
